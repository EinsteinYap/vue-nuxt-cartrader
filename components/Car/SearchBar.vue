<template>
     <div
            class="font-serif w-[80%] text-2xl rounded-full bg-white flex justify-between overflow-hidden drop-shadow-2xl mx-auto"
          >
            <input
              type="text"
              class="py-3 px-5 w-full text-2xl rounded-full focus:outline-none"
              :style="{ border: cityError? 'red 5px solid' : 'none' }"
...
const handleSearch =()=>{
  if(!city.value){
    console.log('ya',cityError.value)
